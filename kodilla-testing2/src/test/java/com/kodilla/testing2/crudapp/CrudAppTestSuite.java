...
class CrudAppTestSuite {
    private static final String BASE_URL = "https://ktubbo.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("someEmail@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("somePassword");
